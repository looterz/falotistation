...
//I have no idea what I'm doing, so I'll just copy and paste the screw driver code. 	
/obj/item/crowbar/suicide(var/mob/user as mob)
	user.visible_message("<span style=\"color:red\"><b>[user] beats /himself in the head with a crowbar, like some kind of suicidal theoretical physicist.</b></span>")
